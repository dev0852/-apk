...
import com.example.maptest.route.DrivingRouteOverLay;
import com.example.maptest.util.*;
...
public class RoutePOIActivity extends Activity implements OnMapClickListener,
    ...
    public void ongasClick(View view) throws AMapException {
    ...
    public void onATMClick(View view) throws AMapException {
    ...
    public void onMaiClick(View view) throws AMapException {
    ...
    public void onToiClick(View view) throws AMapException {
    ...
    private void searchRoutePOI(RoutePOISearchType type) throws AMapException {
        if (overlay != null) {
